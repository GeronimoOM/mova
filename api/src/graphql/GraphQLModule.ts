...
import { MercuriusDriver, MercuriusDriverConfig, MercuriusPlugin } from '@nestjs/mercurius';
import { MercuriusValidationOptions } from "mercurius-validation"
import mercuriusValidationPlugin from 'mercurius-validation';

export const GraphQLModule = NestGraphQlModule.forRootAsync<MercuriusDriverConfig>({
