...
const documents = {
  'fragment LanguageWords on Language {\n  words {\n    items {\n      id\n    }\n    hasMore\n  }\n}\n\nfragment LanguageProperties on Language {\n  properties(partOfSpeech: $partOfSpeech) {\n    ... on TextProperty {\n      id\n    }\n    ... on OptionProperty {\n      id\n    }\n  }\n}\n\nfragment WordFields on Word {\n  id\n  original\n  translation\n  partOfSpeech\n  properties {\n    ... on TextPropertyValue {\n      property {\n        id\n        name\n        type\n      }\n      text\n    }\n    ... on OptionPropertyValue {\n      property {\n        id\n        name\n        type\n      }\n      option {\n        id\n        value\n      }\n    }\n  }\n}\n\nfragment TextPropertyFields on TextProperty {\n  id\n  name\n  type\n  partOfSpeech\n}\n\nfragment OptionPropertyFields on OptionProperty {\n  id\n  name\n  type\n  partOfSpeech\n  options {\n    id\n    value\n  }\n}':
    types.LanguageWordsFragmentDoc,
...
export function graphql(
  source: 'fragment LanguageWords on Language {\n  words {\n    items {\n      id\n    }\n    hasMore\n  }\n}\n\nfragment LanguageProperties on Language {\n  properties(partOfSpeech: $partOfSpeech) {\n    ... on TextProperty {\n      id\n    }\n    ... on OptionProperty {\n      id\n    }\n  }\n}\n\nfragment WordFields on Word {\n  id\n  original\n  translation\n  partOfSpeech\n  properties {\n    ... on TextPropertyValue {\n      property {\n        id\n        name\n        type\n      }\n      text\n    }\n    ... on OptionPropertyValue {\n      property {\n        id\n        name\n        type\n      }\n      option {\n        id\n        value\n      }\n    }\n  }\n}\n\nfragment TextPropertyFields on TextProperty {\n  id\n  name\n  type\n  partOfSpeech\n}\n\nfragment OptionPropertyFields on OptionProperty {\n  id\n  name\n  type\n  partOfSpeech\n  options {\n    id\n    value\n  }\n}',
): (typeof documents)['fragment LanguageWords on Language {\n  words {\n    items {\n      id\n    }\n    hasMore\n  }\n}\n\nfragment LanguageProperties on Language {\n  properties(partOfSpeech: $partOfSpeech) {\n    ... on TextProperty {\n      id\n    }\n    ... on OptionProperty {\n      id\n    }\n  }\n}\n\nfragment WordFields on Word {\n  id\n  original\n  translation\n  partOfSpeech\n  properties {\n    ... on TextPropertyValue {\n      property {\n        id\n        name\n        type\n      }\n      text\n    }\n    ... on OptionPropertyValue {\n      property {\n        id\n        name\n        type\n      }\n      option {\n        id\n        value\n      }\n    }\n  }\n}\n\nfragment TextPropertyFields on TextProperty {\n  id\n  name\n  type\n  partOfSpeech\n}\n\nfragment OptionPropertyFields on OptionProperty {\n  id\n  name\n  type\n  partOfSpeech\n  options {\n    id\n    value\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation CreateLanguage($input: CreateLanguageInput!) {\n  createLanguage(input: $input) {\n    id\n    name\n  }\n}\n\nmutation UpdateLanguage($input: UpdateLanguageInput!) {\n  updateLanguage(input: $input) {\n    id\n    name\n  }\n}\n\nmutation DeleteLanguage($id: ID!) {\n  deleteLanguage(id: $id) {\n    id\n  }\n}\n\nmutation CreateProperty($input: CreatePropertyInput!) {\n  createProperty(input: $input) {\n    ... on TextProperty {\n      ...TextPropertyFields\n    }\n    ... on OptionProperty {\n      ...OptionPropertyFields\n    }\n  }\n}\n\nmutation UpdateProperty($input: UpdatePropertyInput!) {\n  updateProperty(input: $input) {\n    ... on TextProperty {\n      ...TextPropertyFields\n    }\n    ... on OptionProperty {\n      ...OptionPropertyFields\n    }\n  }\n}\n\nmutation CreateWord($input: CreateWordInput!) {\n  createWord(input: $input) {\n    ...WordFields\n  }\n}\n\nmutation UpdateWord($input: UpdateWordInput!) {\n  updateWord(input: $input) {\n    ...WordFields\n  }\n}\n\nmutation DeleteWord($id: ID!) {\n  deleteWord(id: $id) {\n    id\n  }\n}\n\nmutation CreateTopic($input: CreateTopicInput!) {\n  createTopic(input: $input) {\n    id\n    name\n  }\n}\n\nmutation DeleteTopic($id: ID!) {\n  deleteTopic(id: $id) {\n    id\n  }\n}',
): (typeof documents)['mutation CreateLanguage($input: CreateLanguageInput!) {\n  createLanguage(input: $input) {\n    id\n    name\n  }\n}\n\nmutation UpdateLanguage($input: UpdateLanguageInput!) {\n  updateLanguage(input: $input) {\n    id\n    name\n  }\n}\n\nmutation DeleteLanguage($id: ID!) {\n  deleteLanguage(id: $id) {\n    id\n  }\n}\n\nmutation CreateProperty($input: CreatePropertyInput!) {\n  createProperty(input: $input) {\n    ... on TextProperty {\n      ...TextPropertyFields\n    }\n    ... on OptionProperty {\n      ...OptionPropertyFields\n    }\n  }\n}\n\nmutation UpdateProperty($input: UpdatePropertyInput!) {\n  updateProperty(input: $input) {\n    ... on TextProperty {\n      ...TextPropertyFields\n    }\n    ... on OptionProperty {\n      ...OptionPropertyFields\n    }\n  }\n}\n\nmutation CreateWord($input: CreateWordInput!) {\n  createWord(input: $input) {\n    ...WordFields\n  }\n}\n\nmutation UpdateWord($input: UpdateWordInput!) {\n  updateWord(input: $input) {\n    ...WordFields\n  }\n}\n\nmutation DeleteWord($id: ID!) {\n  deleteWord(id: $id) {\n    id\n  }\n}\n\nmutation CreateTopic($input: CreateTopicInput!) {\n  createTopic(input: $input) {\n    id\n    name\n  }\n}\n\nmutation DeleteTopic($id: ID!) {\n  deleteTopic(id: $id) {\n    id\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetLanguages {\n  languages {\n    id\n    name\n  }\n}\n\nquery GetWords($languageId: ID!, $start: Int, $limit: Int, $partOfSpeech: PartOfSpeech, $query: String, $topic: ID) {\n  language(id: $languageId) {\n    id\n    words(\n      start: $start\n      limit: $limit\n      partOfSpeech: $partOfSpeech\n      query: $query\n      topic: $topic\n    ) {\n      items {\n        id\n        original\n        translation\n        partOfSpeech\n      }\n      hasMore\n    }\n  }\n}\n\nquery GetWord($id: ID!) {\n  word(id: $id) {\n    ...WordFields\n  }\n}\n\nquery GetProperties($languageId: ID!, $partOfSpeech: PartOfSpeech) {\n  language(id: $languageId) {\n    id\n    properties(partOfSpeech: $partOfSpeech) {\n      ... on TextProperty {\n        ...TextPropertyFields\n      }\n      ... on OptionProperty {\n        ...OptionPropertyFields\n      }\n    }\n  }\n}\n\nquery GetProperty($id: ID!) {\n  property(id: $id) {\n    ... on TextProperty {\n      ...TextPropertyFields\n    }\n    ... on OptionProperty {\n      ...OptionPropertyFields\n    }\n  }\n}\n\nquery GetTopics($languageId: ID!, $start: Int, $limit: Int, $query: String) {\n  language(id: $languageId) {\n    topics(start: $start, limit: $limit, query: $query) {\n      items {\n        id\n        name\n      }\n      hasMore\n    }\n  }\n}',
