...
export type GetProgressHistoryQuery = { __typename?: 'Query', language?: { __typename?: 'Language', id: string, progress: { __typename?: 'Progress', dailyHistory: { __typename?: 'ProgressHistory', cadence: ProgressCadence, from: string, until: string, instances: Array<{ __typename?: 'ProgressInstance', date: string, points: number }> }, weeklyHistory: { __typename?: 'ProgressHistory', cadence: ProgressCadence, from: string, until: string, instances: Array<{ __typename?: 'ProgressInstance', date: string, points: number }> } } } | null };
